...
# Move update repo script into Library folder
sudo mkdir -pv /Library/iStores
sudo cp /Shared\ Items/coretraining/Do_Not_Delete/Update_Training_Repo.sh /Library/iStores
